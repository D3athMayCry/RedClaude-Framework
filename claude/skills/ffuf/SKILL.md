---
name: ffuf
description: "Fuzzing ativo de conteúdo (diretórios, arquivos, vhosts, parâmetros) com FFUF. Use quando o usuário pedir explicitamente 'fuzz', 'ffuf', 'brute force de diretórios' ou similar. IMPORTANTE: gera tráfego significativo — confirme com o usuário rate limit e janela ANTES de executar os comandos. Requer profundidade standard+."
...
# Fuzzing de Conteúdo e Parâmetros
