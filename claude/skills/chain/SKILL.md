---
name: chain
description: "Encadeia achados confirmados em uma cadeia de ataque (kill chain) para demonstrar impacto real de negócio. Use sempre antes de /report quando houver múltiplos achados, ou quando o usuário pedir 'encadear', 'chain', 'amplificar impacto', 'cadeia de ataque' ou similar. Pura análise, sem tráfego."
