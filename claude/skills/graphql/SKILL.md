---
name: graphql
description: "Testa endpoints GraphQL: introspection, schema reconstruction (clairvoyance), BOLA/BFLA, batching e profundidade de query. Use quando o usuário mencionar 'GraphQL', '/graphql', 'introspection' ou similar. Faz requests ativos — confirme escopo e use contas de teste."
