---
name: retest
description: "Revalida achados após o cliente aplicar correções, confirmando se a remediação foi efetiva e testando bypasses. Use quando o usuário pedir 'reteste', 'verifique correção', 'check de fix' ou similar. Reproduz os passos originais — requer permissão para repetir os testes."
