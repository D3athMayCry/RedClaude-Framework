---
name: jssecrets
description: "Analisa arquivos JavaScript em busca de segredos expostos (chaves de API AWS/Google/Stripe/GitHub, tokens hardcoded) e endpoints internos com LinkFinder, SecretFinder e grep de padrões. Use quando o usuário mencionar 'JS', 'segredos em javascript', 'chaves expostas', 'endpoints em JS' ou similar. Baixa os JS uma vez e analisa offline."
...
# Segredos e Endpoints em JavaScript
