---
name: takeover
description: "Confirma subdomain takeover de forma não-destrutiva usando subzy e nuclei. Use quando houver candidatos de /dns (dangling CNAMEs) ou o usuário pedir 'takeover', 'check de subdomain takeover' ou similar. Confirma a vulnerabilidade SEM executar o takeover de fato."
...
# Confirmação de Subdomain Takeover
