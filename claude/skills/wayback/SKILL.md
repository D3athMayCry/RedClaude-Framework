---
name: wayback
description: "Coleta URLs históricas dos alvos a partir de arquivos públicos (Wayback Machine, Common Crawl, OTX, URLScan) usando gau e waybackurls. Use quando o usuário pedir 'URLs históricas', 'wayback', 'endpoints antigos' ou quiser descobrir parâmetros e arquivos esquecidos. Totalmente passivo."
...
# URLs Históricas (Wayback Machine & Arquivos)
